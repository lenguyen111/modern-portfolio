				...
				<div className="relative z-10 container grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
					<div className="space-y-6">
						...
						<div className="flex gap-4 pt-4">
							{[
								{
									href: "https://github.com/lenguyen111",
									target: "_blank",
								...
								{
									href: "mailto:lenguyen1112011@gmail.com",
									icon: <Mail className="h-5 w-5" />,
									label: "Email",
								},
								{
									href: "https://discord.com/users/1087361687604179125",
									target: "_blank",
									rel: "noopener noreferrer",
								...
								{
									href: "https://www.facebook.com/lenguyenuwu",
									target: "_blank",
									rel: "noopener noreferrer",
							...
							<div className="relative rounded-2xl border border-zinc-700/50 bg-zinc-800/50 p-8 backdrop-blur-sm">
								...
								<div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-2">
									<div className="space-y-1">
										...
										<div className="font-medium">Lê Hoàng Khôi Nguyên</div>
									</div>
									<div className="space-y-1">
										<div className="text-sm text-zinc-500">Email</div>
										<div className="max-w-[180px] truncate font-medium">
											lenguyen1112011@gmail.com
										</div>
									</div>
									<div className="space-y-1">
								...
								{[
									{
										...
										label: "Email",
										value: "lenguyen1112011@gmail.com",
									},
									{
